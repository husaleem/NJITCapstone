...
public class DetectUnknownControllerMappings : MonoBehaviour {
    ...
    void Update () {
        ...
        Debug.Log("right: " + gamepad.rightTrigger.IsValueConsideredPressed(gamepad.rightTrigger.ReadValue()) + " value: " + gamepad.rightTrigger.ReadValue());
        
        Debug.Log("left: " + gamepad.leftTrigger.IsValueConsideredPressed(gamepad.leftTrigger.ReadValue()) + " value: " + gamepad.leftTrigger.ReadValue());
        ...
        if (Input.GetAxis("Axis 3") > 0f)
        {
            ...
            Debug.Log(Input.GetAxisRaw("Axis 3"));
        }
